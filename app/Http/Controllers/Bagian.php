...
class Bagian extends Controller
{
    ...
    {
        $profil= ProfilM::latest()->paginates();
        $bagian= BagianM::latest()->paginates();
        $kebutuhan= kebutuhanM::latest()->paginates();
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('profil.index')->with('success','berhasil di tambahkan');
    }
